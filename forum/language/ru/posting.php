...
$lang = array_merge($lang, array(
	...
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Введите 0 или оставьте поле пустым, чтобы тема всегда была объявлением или прикреплённой. Обратите внимание на то, что это число является относительным к дате публикации сообщения.',
	...
	'TOO_MANY_CHARS_SIG'		=> 'Ваша подпись содержит слишком много знаков: %1$d. Максимальное разрешенное количество: %2$d.',
