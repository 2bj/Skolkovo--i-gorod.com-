...
$lang = array_merge($lang, array(
	...
	'WARNINGS_EXPIRE_EXPLAIN'		=> 'Количество дней, по истечении которых выданное пользователю предупреждение будет автоматически снято с него и удалено из его записей.',
));
...
$lang = array_merge($lang, array(
	...
	'BOARD_PM_EXPLAIN'			=> 'Включение или отключение обмена личными сообщениями для всех пользователей.',
));
...
$lang = array_merge($lang, array(
	...
	'MAX_FILESIZE_EXPLAIN'			=> 'Максимальный размер файлов загружаемых аватар.',
...
$lang = array_merge($lang, array(
	...
	'MIN_CHAR_LIMIT_EXPLAIN'		=> 'Минимальное количество символов, необходимое для публикации сообщений и личных сообщений.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_TOPIC_EXPLAIN'			=> 'Новые сообщения отдельных тем.',
 	...
 	'ACP_FEED_NEWS'						=> 'Канал новостей',
  	'ACP_FEED_NEWS_EXPLAIN'				=> 'Первые сообщения новых тем указанных форумов. Не выбирайте форумов, чтобы отключить канал новостей.<br />Чтобы выбрать несколько форумов, пользуйтесь мышью, удерживая кнопку <samp>CTRL</samp>.',
...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_GD_WAVE'						=> 'Волновое искажение GD CAPTCHA',
	'CAPTCHA_GD_WAVE_EXPLAIN'				=> 'Использовать волновое искажение CAPTCHA.',
	'CAPTCHA_GD_3D_NOISE'					=> 'Добавить 3D-шум',
	'CAPTCHA_GD_3D_NOISE_EXPLAIN'			=> 'Опция добавляет к CAPTCHA дополнительные объекты, располагая их поверх символов.',
	'CAPTCHA_GD_FONTS'						=> 'Использовать другие шрифты',
	'CAPTCHA_GD_FONTS_EXPLAIN'				=> 'Позволяет управлять количеством используемых форм для отображения символов. Вы можете использовать формы по умолчанию или добавить измененные символы. Также возможно добавление символов в нижнем регистре.',
	...
	'CAPTCHA_SELECT_EXPLAIN'				=> 'В этом списке содержатся модули CAPTCHA, распознанные вашей конференцией. Модули, помеченные серым цветом, возможно, нуждаются в предварительной настройке, и поэтому недоступны для использования в текущее время.',
	...
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> 'Опция позволяет пользователям запрашивать новый код подтверждения, если они не смогли его прочесть во время регистрации. Некоторые модули могут не поддерживать эту функцию.',
));
