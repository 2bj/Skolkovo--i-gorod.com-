									...
									<div class="bottom_left_bg equal">
										<div class="left-indent">
											<div class="wrapper-box module_menu">
												<div class="clear">
													<div class="boxIndent">
														<div><img style="margin-left:28px;" title="History of the Project" src="/images%pre_lang%/h1_start_.gif" alt="History of the Project" /></div>
														<div xmlns:umi="umi" umi:element-id="%content get_page_id('/infoblocks/ist-left/')%" umi:field-name="content">%content insert('/infoblocks/ist-left/')%</div>
													</div>
												</div>
											</div>
										</div>
