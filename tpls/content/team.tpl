									...
									<div class="bottom_left_bg equal">
										<div class="left-indent">
											<div class="wrapper-box module_menu">
												<div class="clear">
													<div class="boxIndent">
														<div><img style="margin-left:25px;" title="Люди в проекте" src="/images/h1_people_%pre_lang%.gif" alt="Люди в проекте" /></div>
														<div xmlns:umi="umi" umi:element-id="330" umi:field-name="content">%content insert('330')%</div>
													</div>
												</div>
											</div>
										</div>
