...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ru" xmlns:umi="http://www.umi-cms.ru/TR/umi">
	...
	<body id="body">
		<div class="main">
			<div class="header">
				...
				<div class="lang-selector" style="text-align:right;">
					<div style="float:right; height:31px; padding-top:10px;">
						<nobr>
							<span style="margin:10px; font-weight:bold; vertical-align:middle;"><a href="%content get_page_url(%pid%,1)%" style="text-decoration:none; color:#6a6a6a;" title="Русский">РУС</a></span>
							<span style="margin:10px; font-weight:bold; vertical-align:middle; background-color:#f1f1f1; padding:3px 7px;">ENG</span>
			...
			<div class="wrapper">
				<!--banner--><div xmlns:umi="umi" umi:element-id="%content get_page_id('/infoblocks/banner/')%" umi:field-name="content">%content insert('/infoblocks/banner/')%</div>
									...
									<div class="bottom_left_bg equal">
										<div class="left-indent">
											<div class="wrapper-box module_menu">
												<div class="clear">
													<div class="boxIndent">
														<div><img style="margin-left:28px;" title="Vacancies of the Working Group" src="/images%pre_lang%/h1_vacancies_.gif" alt="Vacancies of the Working Group" /></div>
									...
									<div class="article-text-indent">
										<div class="clear">
											<table class="contentpaneopen">
												<tr><td valign="top">
													<div xmlns:umi="umi" umi:element-id="%content get_page_id('/infoblocks/vacancies-text/')%" umi:field-name="content">%content insert('/infoblocks/vacancies-text/')%</div>
			...
			<div class="tail-footer clear">
				<div class="main">
					<div class="footer" xmlns:umi="umi" umi:element-id="%content get_page_id('/infoblocks/copyright/')%" umi:field-name="content"><!--copyrights-->%content insert('/infoblocks/copyright/')%</div>
				</div>
			</div>
		</div>
