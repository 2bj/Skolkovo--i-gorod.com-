								...
								<div class="top_left_bg equal">
									<div class="bottom_left_bg equal">
										<div class="left-indent">
											<div class="wrapper-box module_menu" style="margin-top:-3px;">
												<div class="clear">
													<div class="boxIndent">
														<div><img style="margin-left:28px;" title="Partners and Friends" src="/images%pre_lang%/h1_partners_.gif" alt="Partners and Friends" /></div>
													</div>
												</div>
											</div>
										</div>
