...
$help = array(
	...
	array(
		...
		1 => 'Это программное обеспечение было создано и лицензировано phpBB Group. Если вы считаете, что какая-то функция должна быть добавлена, посетите сайт phpbb.com и узнайте, что по этому поводу думает phpBB Group. Не оставляйте запросов о добавлении каких-либо функций на конференции phpbb.com, Группа использует SourceForge для работы над новыми функциями. Сначала просмотрите форумы, чтобы выяснить, каково наше мнение по поводу данной функции (если такое мнение у нас есть) и только после этого следуйте процедуре, которая там будет описана.'
	),
	array(
