				...
				<div class="lang-selector" style="text-align:right;">
					<div style="float:right; height:31px; padding-top:10px;">
						<nobr>
							...
							<!--<span style="margin:10px; font-weight:bold; vertical-align:middle;"><a href="/de%content get_page_url(%pid%,1)%" style="text-decoration:none; color:#6a6a6a;" title="Deutsch">DEU</a></span>-->						</nobr>
					</div>
				</div>
			</div>
			<div class="wrapper">
									...
									<div class="bottom_left_bg equal">
										<div class="left-indent">
											<div class="wrapper-box module_menu">
												<div class="clear">
													<div class="boxIndent">
														<div><img style="margin-left:28px;" title="Будущее проекта" src="/images/h1_future_%pre_lang%.gif" alt="Будущее проекта" /></div>
													</div>
												</div>
											</div>
										</div>
