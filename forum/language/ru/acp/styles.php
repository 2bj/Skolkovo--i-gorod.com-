...
$lang = array_merge($lang, array(
	...
	'IMG_TOPIC_UNREAD_HOT'			=> 'Популярная тема с новыми сообщениями',
	'IMG_TOPIC_UNREAD_HOT_MINE'		=> 'Популярная тема с новыми сообщениями, содержащая мои сообщения',
	...
	'IMG_STICKY_READ'				=> 'Прикреплённая тема',
	'IMG_STICKY_READ_MINE'			=> 'Прикреплённая тема с моими сообщениями',
	'IMG_STICKY_READ_LOCKED'		=> 'Закрытая прикреплённая тема',
	'IMG_STICKY_READ_LOCKED_MINE'	=> 'Закрытая прикреплённая тема с моими сообщениями',
	'IMG_STICKY_UNREAD'				=> 'Прикреплённая тема с новыми сообщениями',
	'IMG_STICKY_UNREAD_MINE'		=> 'Прикреплённая тема с новыми и с моими сообщениями',
	'IMG_STICKY_UNREAD_LOCKED'		=> 'Закрытая прикреплённая тема с новыми сообщениями',
	'IMG_STICKY_UNREAD_LOCKED_MINE'	=> 'Закрытая прикреплённая тема с новыми и с моими сообщениями',
