				...
				<div class="lang-selector" style="text-align:right;">
					<div style="float:right; height:31px; padding-top:10px;">
						<nobr>
							...
							<span style="margin:10px; font-weight:bold; vertical-align:middle;"><a href="/en/newslist/" style="text-decoration:none; color:#6a6a6a;" title="English">ENG</a></span>
									...
									<div class="bottom_left_bg equal">
										<div class="left-indent">
											<div class="wrapper-box module_menu">
												<div class="clear">
													<div class="boxIndent">
														<div><a href="%pre_lang%/newslist/"><img style="margin-left:28px;" title="News und Events" src="/images%pre_lang%/h1_news_.gif" alt="News und Events" /></a></div>
