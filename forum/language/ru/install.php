...
$lang = array_merge($lang, array(
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		...
		<p>Нажав на кнопку ниже, вы попадёте на страницу отправки статистических данных phpBB в панели администрирования (ACP). Мы будем вам очень признательны, если вы поможете нам, отправив немного статистической информации о вашем сервере и конфигурации phpBB. На основе этой информации мы будем принимать решения о функциональности будущего phpBB. Затем ознакомьтесь с имеющимися пунктами меню и настройками панели администрирования. Освоение имеющихся возможностей phpBB3 может занять некоторое время. Помните о доступной в интернете <a href="http://www.phpbb.com/support/documentation/3.0/">документации</a>, <a href="%3$s">встроенном файле README</a> и <a href="http://www.phpbb.com/community/viewforum.php?f=46">форуме поддержки</a> (на английском) а также официальном форуме русскоязычной поддержки <a href="http://phpbbguru.net">phpBB Guru</a>.</p><p><strong>Удалите, переместите или переименуйте папку «install» перед использованием конференции. В противном случае будет доступен только администраторский раздел.</strong>',
	...
	'INST_ERR_DB_FORUM_PATH'	=> 'Указанный файл базы данных находится в папке конференции. Необходимо переместить его в папку, недоступную с интернета.',
