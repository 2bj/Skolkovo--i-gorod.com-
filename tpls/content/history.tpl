									...
									<div class="bottom_left_bg equal">
										<div class="left-indent">
											<div class="wrapper-box module_menu">
												<div class="clear">
													<div class="boxIndent">
														<div><img style="margin-left:28px;" title="История проекта" src="/images/h1_start_%pre_lang%.gif" alt="История проекта" /></div>
														<div xmlns:umi="umi" umi:element-id="329" umi:field-name="content">%content insert('329')%</div>
													</div>
												</div>
											</div>
										</div>
