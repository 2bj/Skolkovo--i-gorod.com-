				...
				<div class="lang-selector" style="text-align:right;">
					<div style="float:right; height:31px; padding-top:10px;">
						<nobr>
							...
							<span style="margin:10px; font-weight:bold; vertical-align:middle;"><a href="/en/press/" style="text-decoration:none; color:#6a6a6a;" title="English">ENG</a></span>
									...
									<div class="bottom_left_bg equal">
										<div class="left-indent">
											<div class="wrapper-box module_menu">
												<div class="clear">
													<div class="boxIndent">
														<div><a href="%pre_lang%/press/"><img style="margin-left:28px;" title="Press über das Projekt" src="/images%pre_lang%/h1_press_.gif" alt="Press über das Projekt" /></a></div>
