									...
									<div class="bottom_left_bg equal">
										<div class="left-indent">
											<div class="wrapper-box module_menu">
												<div class="clear">
													<div class="boxIndent">
														<div><img style="margin-left:25px;" title="People in the Project" src="/images%pre_lang%/h1_people_.gif" alt="People in the Project" /></div>
														<div xmlns:umi="umi" umi:element-id="%content get_page_id('/infoblocks/team-left/')%" umi:field-name="content">%content insert('/infoblocks/team-left/')%</div>
													</div>
												</div>
											</div>
										</div>
